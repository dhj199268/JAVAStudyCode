...
<body>
	...
	<div id="loginbox">
		...
		<div class="form-group">
			<div class="input-group" style="margin-left: 80px;">
				<span class="input-group-addon"><i class="icon-lock"></i></span> <input
					type="password" class="form-control" name="userPass" id="userPass"
		...
		<div class="form-group">
			<div class="input-group" style="margin-left: 80px;">
				<span class="input-group-addon"><i class="icon-lock"></i></span> <input
					type="text" class="form-control" name="authCode" id="authCode"
					placeholder="请输入验证码" style="width: 123px; display: inline;">
				<img id="authCodeImg" class="yanzheng" alt="验证码" src="" width="0"
					height="0" onclick="randomImg()"
					style="margin-left: -20px; margin-top: 5px; height: 22px; width: 66px;" />
				<span style="font-size: 12px;"><a class=""
					href="javascript:;" onclick="randomImg()">点击换一张</a></span>
			</div>
		</div>
